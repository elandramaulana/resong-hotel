        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-start">
                    <h1 class="h3 mb-0 text-gray-800">Tambah Supplier Assets</h1>
                </div>
            </div>
                ...
                <div class="container-fluid mt-4">
                    <div class="card">
                        <div class="card-body text-dark">
                            ...
                            <form action="{{ route('inventory-assets.supplier.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="" name="supplier_name" type="text" class="form-control"
                                            id="supplier_name">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="" name="supplier_telp" type="text" class="form-control"
                                            id="supplier_telp">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="" name="supplier_alamat" type="text" class="form-control"
                                            id="supplier_alamat">
