...
<div class="container-fluid mt-4">
    <form action="{{route('update.menu', $menu->menu_id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body text-dark">
                    <div class="row">
                     ...
                     <div class="mb-3">
                        ...
                        <input value="{{$menu->menu_name}}" name="menu_name" type="text" class="form-control" id="menu_name">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input value="{{$menu->menu_price}}" name="menu_price" type="number" class="form-control" id="menu_price">
