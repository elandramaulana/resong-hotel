...
<div class="container-fluid mt-4">
        <div class="card">
            <div class="card-body text-dark">
                ...
                <form action="{{route('store.kategori.menu')}}" method="post" enctype="multipart/form-data">
                     @csrf
                    <div class="row">

                     <div class="mb-3">
                        <label for="nama_kategori" class="form-label">Nama</label>
                        <input value="" name="nama_kategori" type="text" class="form-control" id="nama_kategori">
