...
<div class="container-fluid mt-4">
        <div class="card">
            <div class="card-body text-dark">
                ...
                <form action="{{ route('supplier.update', ['id' => $supplier->id]) }}" method="" enctype="multipart/form-data">
                     @csrf
                     @method('PUT')
                    <div class="row">
                     ...
                     <div class="mb-3">
                        ...
                        <input value="{{ $supplier->supplier_name }}" name="supplier_name" type="text" class="form-control" id="supplier_name">
                        <x-input-error :messages="$errors->get('supplier_name')" class="mt-2" />
                    </div>

                     <div class="mb-3">
                        <label for="supplier_telp" class="form-label">No Telp</label>
                        <input value="{{ $supplier->supplier_telp }}" name="supplier_telp" type="text" class="form-control" id="supplier_telp">
                        <x-input-error :messages="$errors->get('supplier_telp')" class="mt-2" />
                    </div>

                     <div class="mb-3">
                        <label for="supplier_alamat" class="form-label">Alamat</label>
                        <input value="{{ $supplier->supplier_alamat }}" name="supplier_alamat" type="text" class="form-control" id="supplier_alamat">
