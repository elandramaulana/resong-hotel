                ...
                <form action="{{route('store.trans.barang')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input readonly value="MASUK" name="trans_jenis" type="text" class="form-control" id="trans_jenis">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="trans_suplier" class="form-control" id="supplier">
                            @foreach($supplier as $sup)
                                <option value="{{ $sup->supplier_name }}" {{ $sup->supplier_name === old('supplier') ? 'selected' : '' }} >{{ $sup->supplier_name }}</option>
                            @endforeach
