            ...
            <div class="col-sm-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3 class="font-weight-bold text-dark">Manage Kategori Barang</h3>
                            </div>
                            <div class="col-sm-6 d-flex justify-content-end">
                                <button class="btn btn-extend">
                                    <a style="text-decoration: none; color:white" href="{{route('tambah.kategori')}}">Tambah</a>
                                </button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div>
                                                <button style="margin-right: 10px" type="submit" class="btn btn-warning btn-sm mt-2">
                                                    <a style="color: black" href="{{ route('edit.kategori', $cat->id) }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                </button>                                                
                                                <form action="{{ route('destroy.kategori', $cat->id) }}" method="POST" style="display: inline;" id="deleteForm{{$cat->id}}">
                                                    @csrf
                                                    @method('DELETE')
