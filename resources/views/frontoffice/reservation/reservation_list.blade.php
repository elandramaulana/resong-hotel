                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="reservationListTable" width="100%"
                                        cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $dt)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            <button class="btn btn-warning rounded dropdown-toggle"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('edit_reservation', $dt->reservation_id) }}">Edit</a>
                                                                </li>
                                                                <li><a class="dropdown-item btn-cancel"
                                                                        data-id="{{ $dt->reservation_id }}">Cancel
                                                                        Reservation</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
