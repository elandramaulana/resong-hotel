                                        ...
                                        <table class="table ">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td style="width: 2%">:</td>
                                                    <td style="width: 70%">{{ $tamu_detail['reservation_name'] }} <input
                                                            hidden type="text" name="reservation_name"
                                                            value="{{ $tamu_detail['reservation_name'] }}"></td>
                                                </tr>
                                                <tr>
                                                    <td>Kontak</td>
                                                    <td>:</td>
                                                    <td>{{ $tamu_detail['reservation_contact'] }} <input hidden
                                                            type="text" name="reservation_contact"
                                                            value="{{ $tamu_detail['reservation_contact'] }}"></td>
                                                </tr>
                                                <tr>
                                                    <td>Email</td>
                                                    <td>:</td>
                                                    <td>{{ $tamu_detail['reservation_email'] }} <input type="text" hidden
                                                            name="reservation_email"
                                                            value="{{ $tamu_detail['reservation_email'] }}"></td>
                                                </tr>
                                                <tr>
                                                    <td>Jumlah Tamu</td>
                                                    <td>:</td>
                                                    <td>{{ $tamu_detail['qty_guest'] }}<input type="text" hidden
                                                            name="qty_guest" value="{{ $tamu_detail['qty_guest'] }}"></td>
                                                    <input type="text" name="reservation_desc"
                                                        value="{{ $tamu_detail['reservation_desc'] }}" hidden>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        <table class="table">
                                            ...
                                            @endphp
                                            <input type="text" name="reservation_chanel" id="reservation_chanel" hidden
                                                value="{{ $tamu_detail['reservation_chanel'] }}">
                                            <thead>
                                                <tr>
                                                    <td style="width: 30%">Nama Kamar</td>
                                                    <td style="width: 2%">:</td>
                                                    <td style="width: 70%">{{ $room_detail->room_name }} <input hidden
                                                            type="text" name="room_id" value="{{ $room_detail->id }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Type Kamar</td>
                                                    <td>:</td>
                                                    <td>{{ $room_detail->room_type }}<input type="text" hidden
                                                            name="room_name" value="{{ $room_detail->room_type }}"></td>
                                                </tr>
                                                <tr>
                                                    <td>Harga Kamar</td>
                                                    <td>:</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>{{ $showTglCheckin }} / {{ $showTglCheckout }} <input hidden
                                                            type="text" name="reservation_checkin"
                                                            value="{{ $tamu_detail['reservation_checkin'] }}"> <input
                                                            hidden type="text" name="reservation_checkout"
                                                            value="{{ $tamu_detail['reservation_checkout'] }}"> <a
                                                            class="badge badge-success">({{ $tamu_detail['qty_hari'] }}
                                                            Hari)</a></td>
                                                </tr>
                                            </thead>
                                        </table>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="reservation_payment_status" id="reservation_payment_status"
                                            ...
                                            <option value="DP"
                                                {{ 'DP' === old('reservation_payment_status') ? 'selected' : '' }}>DP
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="reservation_payment_method" id="reservation_payment_method"
                                            ...
                                            <option value="Cash"
                                                {{ 'Cash' === old('reservation_payment_method') ? 'selected' : '' }}>Cash
                                            </option>
                                            <option value="Bank Transfer"
                                                {{ 'Bank Transfer' === old('reservation_payment_method') ? 'selected' : '' }}>
