<script type="text/javascript">
    $(function () {
        ...
        var total = {{ $subTotal }};
        var grandTotal = total - deposit; // Subtract deposit from total
        ...
        $("#inputDiscount").on('input', function () {
            ...
            // Calculate grand total after discount and deposit
            var discountAmount = (total * discount) / 100;
            grandTotal = total - discountAmount - deposit; // Include deposit in calculation
            $("#inputGrandTotal").val(formatCurrency(grandTotal));
