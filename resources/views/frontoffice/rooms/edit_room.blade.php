    ...
    <div class="container-fluid mt-4">
        <div class="card">
            <div class="card-body text-dark">
                <form action="{{ route('update.room', $rooms->id)}}" method="POST" id="formDetailCheckin">
                    @csrf
                    @method('PUT') 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$rooms->room_name}}" name="room_name" type="text" class="form-control" id="room_name" >
                                <x-input-error :messages="$errors->get('room_name')" class="mt-2"/>
                            </div>

                            <div class="mb-3">
                                <label for="room_no" class="form-label">No</label>
                                <input value="{{$rooms->room_no}}" name="room_no" type="text" class="form-control" id="room_no" >
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$rooms->room_capacity}}" name="room_capacity" type="number" class="form-control" id="room_capacity">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="room_extrabed" class="form-control" id="room_extrabed">
                                    <option value="{{$rooms->room_extrabed}}" disabled selected>{{$rooms->room_extrabed ? "Yes" : "No"}}</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="room_type" type="text" class="form-control" value="{{$rooms->room_type}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$rooms->bed_type}}"  type="text" class="form-control" name="bed_type" id="no_rek">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{$rooms->room_price}}" name="room_price" type="number" class="form-control" id="room_price">
