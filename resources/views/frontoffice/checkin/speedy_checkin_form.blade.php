                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-6">
                                            ...
                                            <input name="speedy_checkin_time" value="" type="text" readonly
                                                class="form-control" id="checkinTime"
                                        ...
                                        <div class="mb-3 col-6">
                                            ...
                                            <input name="speedy_checkin_hour" type="time" required class="form-control"
                                                id="checkinHour">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-12">
                                            ...
                                            <input readonly name="speedy_checkout_time" value="" type="text"
                                                class="form-control" id="checkoutTime"
                                                onfocus="(this.type='date');this.focus()"
                                                onblur="(this.type='text');this.value=formatDate(this.value)">
                                        </div>
                                        {{-- <div class="mb-3 col-6">
                                                                            ...
                                                                            <div class="row">
                                                                                <table>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td id="show_deposit_cash">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                id="deposit"
                                                                                                class="form-control"
                                                                                                placeholder="Input Deposit Min 50.000"
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        id="remaining_payment" hidden>
                                                                                    <tr>
                                                                                        <td>Remaining Payment</td>
                                                                                        <td>:</td>
                                                                                        <td align="right">
                                                                                            <div
                                                                                                id="remaining-payment-value">
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
