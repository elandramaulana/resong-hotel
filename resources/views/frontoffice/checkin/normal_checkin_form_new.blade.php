                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-10">
                                                    ...
                                                    <input type="text" class="form-control" id="name_guest"
                                                        name="name_guest" value="{{ old('name_guest') }}"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control" id="frm_email"
                                                        name="frm_email" value="{{ old('frm_email') }}" placeholder="Email">
                                                    <x-input-error :messages="$errors->get('frm_email')" class="mt-2" />
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <label for="date_of_birth">No Telp</label>
                                                    <input type="text" class="form-control" id="telp_number"
                                                        name="telp_number" value="{{ old('telp_number') }}"
                                                        placeholder="No Telp">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <select name="agama" id="agama" class="form-control">
                                                        ...
                                                        <option value="Islam"
                                                            {{ 'Islam' === old('agama') ? 'selected' : '' }}>Islam</option>
                                                        <option value="Kristen"
                                                            {{ 'Kristen' === old('agama') ? 'selected' : '' }}>Kristen
                                                        </option>
                                                        <option value="Katolik"
                                                            {{ 'Katolik' === old('agama') ? 'selected' : '' }}>Katolik
                                                        </option>
                                                        <option value="Hindu"
                                                            {{ 'Hindu' === old('agama') ? 'selected' : '' }}>Hindu</option>
                                                        <option value="Buddha"
                                                            {{ 'Buddha' === old('agama') ? 'selected' : '' }}>Buddha
                                                        </option>
                                                        <option value="Konghucu"
                                                            {{ 'Konghucu' === old('agama') ? 'selected' : '' }}>Konghucu
                                                        </option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-9">
                                                    ...
                                                    <input type="text" class="form-control" id="city"
                                                        name="city" value="{{ old('city') }}" placeholder="Kota">
                                                    <x-input-error :messages="$errors->get('country')" class="mt-2" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoice"
                                                        name="invoice" value="{{ $no_invoice }}" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <input type="date" name="checkin_time" class="form-control"
                                                        value="{{ date('Y-m-d') }}" id="checkin_time">
                                                    <x-input-error :messages="$errors->get('checkin_time')" class="mt-2" />
                                                </div>
                                                <div class="form-group col-lg-2">
                                                    <label for="checkinHour">Time</label>
                                                    <input type="time" class="form-control" id="checkinHour"
                                                        name="checkinHour" id="checkinHour"
                                                        value="{{ old('checkinHour') }}">
                                                    <x-input-error :messages="$errors->get('checkinHour')" class="mt-2" />
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <label for="checkout_time">Check-out Date</label>
                                                    <input type="date" class="form-control" id="checkout_time"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <input type="number" class="form-control" id="number_of_adult"
                                                        name="number_of_adult" max="{{ $Room->room_capacity }}"
                                                        value="{{ old('number_of_adult', 1) }}">
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="channel" class="form-control" id="channel">
                                                        <option value="Walk-in"
                                                            {{ 'Walk-in' === old('channel') ? 'selected' : '' }}>Walk-in
                                                        </option>
                                                        <option value="Traveloka"
                                                            {{ 'Traveloka' === old('channel') ? 'selected' : '' }}>
                                                            Traveloka
                                                        </option>
                                                        <option value="Booking.com"
                                                            {{ 'Booking.com' === old('channel') ? 'selected' : '' }}>
                                                            Booking.com
                                                        </option>
                                                        <option value="Tiket.com"
                                                            {{ 'Tiket.com' === old('channel') ? 'selected' : '' }}>
                                                            Tiket.com
                                                        </option>
                                                        <option value="Agoda"
                                                            {{ 'Agoda' === old('channel') ? 'selected' : '' }}>
                                                            Agoda</option>
                                                    </select>
                                                ...
                                                <div class="form-group col-lg-6 form-check">
                                                    ...
                                                    <input type="checkbox" class="form-check-input" id="extrabed"
                                                        name="extrabed" value="1"
                                                        {{ old('extrabed', 0) ? 'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6" id="show_deposit_cash">
                                                    ...
                                                    <input type="text" class="form-control" id="deposit"
                                                        ...
                                                        placeholder="Masukan Besar Deposit">
                                                ...
                                                <div class="form-group col-lg-6" id="show_deposit_lain">
                                                    ...
                                                    <input type="text" class="form-control" id="deposit_lain"
                                                        name="deposit_lain" value="{{ old('deposit_lain') }}"
                                                        placeholder="Inputkan Deposit lain-lain Ex: KTP, SIM dan lain-lain ">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" id="total_bayar"
                                                        placeholder="Total Bayar " name="total_bayar"
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <select name="payment_method" id="payment_method"
                                                        class="form-control">
                                                        <option value="Cash"
                                                            {{ 'Cash' === old('payment_method') ? 'selected' : '' }}>Cash
                                                        </option>
                                                        <option value="Bank Transfer"
                                                            {{ 'Bank Transfer' === old('payment_method') ? 'selected' : '' }}>
                                                            Bank Transfer</option>
                                                        <option value="Qris"
                                                            {{ 'Qris' === old('payment_method') ? 'selected' : '' }}>Qris
                                                        </option>
                                                        <option value="Dana"
                                                            {{ 'Dana' === old('payment_method') ? 'selected' : '' }}>Dana
                                                        </option>
                                                        <option value="Go-Pay"
                                                            {{ 'Go-Pay' === old('payment_method') ? 'selected' : '' }}>
                                                            Go-Pay</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <p>Check-in Date: <span
                                                                    id="summary_checkin_date">{{ old('checkin_time', date('Y-m-d')) }}</span>
                                                            </p>
                                                            <p>Check-out Date: <span
                                                                    id="summary_checkout_date">{{ old('checkout_time') }}</span>
                                                            </p>
                                                            <p>Duration: <span id="summary_duration">0</span> nights</p>
                                                            <p>Extrabed: Rp <span id="extrabed_price">0</span></p>
                                                            <input type="text" name="extrabed_price"
                                                                id="extrabed_price_input" value="0" hidden>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <p>Room Price / Night: Rp <span
                                                                    id="summary_room_price">{{ number_format($Room->room_price, 0, ',', '.') }}</span>
                                                            </p>
                                                            <p>Tax ({{ $Settings->pajak_checkin }} %): <span
                                                                    id="showPajak"></span></p>
                                                            <input type="text" name="tax" id="tax"
                                                                value="{{ $Settings->pajak_checkin }}" hidden>
