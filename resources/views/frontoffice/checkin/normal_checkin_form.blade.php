                            ...
                            <div class="card-body text-dark">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 text-warning text-center">
                                        <h6 class="shape rounded p-2">{{ $Room['room_name'] }}
                                            (@RP{{ $Room['room_price'] }})</h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ $no_invoice }}" name="invoice" type="text"
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-6">
                                                ...
                                                <input readonly value="{{ $checkin_time }}" name="checkin_time"
                                                    type="text" class="form-control" id="checkinTime"
                                            ...
                                            <div class="mb-3 col-6">
                                                ...
                                                <input name="checkin_hour" type="time" class="form-control"
                                                    id="checkinHour">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="number_of_adult"
                                                value="{{ $Room['room_capacity'] }}{{ old('number_of_adult') }}"
                                                type="number" class="form-control" id="adults">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="channel" class="form-control" id="channel">
                                                <option value="Walk-in"
                                                    {{ 'Walk-in' === old('channel') ? 'selected' : '' }}>Walk-in</option>
                                                <option value="Traveloka"
                                                    {{ 'Traveloka' === old('channel') ? 'selected' : '' }}>Traveloka
                                                </option>
                                                <option value="Booking.com"
                                                    {{ 'Booking.com' === old('channel') ? 'selected' : '' }}>Phone-in
                                                </option>
                                                <option value="Tiket.com"
                                                    {{ 'Tiket.com' === old('channel') ? 'selected' : '' }}>Tiket.com
                                                </option>
                                                <option value="Agoda" {{ 'Agoda' === old('channel') ? 'selected' : '' }}>
                                                    Syifa Travel</option>
                                            </select>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-6">
                                                ...
                                                <input value="{{ old('checkout_time') }}" name="checkout_time"
                                                    type="date" class="form-control" id="checkoutTime"
                                                    onfocus="(this.type='date');this.focus()"
                                                    onblur="(this.type='text');this.value=formatDate(this.value)">
                                            ...
                                            <div class="mb-3 col-6">
                                                ...
                                                <input name="checkout_hour" type="time" class="form-control"
                                                    id="checkoutHour">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ old('number_of_children') }}" name="number_of_children"
                        ...
                        <div class="card">
                            <div class="card-body text-dark">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <select name="id_type" class="form-control" id="id_type">
                                                <option value="KTP" {{ 'KTP' === old('id_type') ? 'selected' : '' }}>
                                                    KTP</option>
                                                <option value="SIM" {{ 'SIM' === old('id_type') ? 'selected' : '' }}>
                                                    SIM</option>
                                            </select>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input value="{{ old('name_guest') }}" type="text" name="name_guest"
                                            class="form-control clearable" id="name_guest">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="place_of_birth" value="{{ old('place_of_birth') }}" type="text"
                                            class="form-control clearable" id="place_of_birth">
                                        <x-input-error :messages="$errors->get('place_of_birth')" class="mt-2" />
                                    </div>

                                    <div class="col-sm-4">
                                        <input value="{{ old('date_of_birth') }}" name="date_of_birth" type="text"
                                            class="form-control clearable" id="date_of_birth"
                                            onfocus="(this.type='date');this.focus()"
                                            onblur="(this.type='text');this.value=formatDate(this.value)">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="mb-3">
                                            <select name="religion" class="form-control" id="agama">
                                                ...
                                                <option value="Islam"
                                                    {{ 'Islam' === old('religion') ? 'selected' : '' }}>Islam</option>
                                                <option value="Kristen"
                                                    {{ 'Kristen' === old('religion') ? 'selected' : '' }}>Kristen</option>
                                                <option value="Katolik"
                                                    {{ 'Katolik' === old('religion') ? 'selected' : '' }}>Katolik</option>
                                                <option value="Hindu"
                                                    {{ 'Hindu' === old('religion') ? 'selected' : '' }}>Hindu</option>
                                                <option value="Buddha"
                                                    {{ 'Buddha' === old('religion') ? 'selected' : '' }}>Buddha</option>
                                                <option value="Konghucu"
                                                    {{ 'Konghucu' === old('religion') ? 'selected' : '' }}>Konghucu
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="country" type="text" value="{{ old('country') }}"
                                            class="form-control clearable" id="country">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="province" type="text" class="form-control clearable"
                                            value="{{ old('province') }}" id="provinsi">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="city" type="text" class="form-control clearable"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="postal_code" type="text" class="form-control clearable"
                                            id="frm_kodepos" value="{{ old('postal_code') }}">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="email_address" type="text" class="form-control clearable"
                                            id="frm_email" value="{{ old('email_address') }}">
                                ...
                                <div class=" mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input value="{{ old('telp_number') }}" name="telp_number" type="text"
                                            class="form-control clearable" id="contact">
                                ...
                                <div class=" mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input value="{{ old('room_name') }}" name="room_name" type="text"
                                            class="form-control clearable" id="contact">
                                ...
                                <div class=" mt-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input value="{{ old('room_price') }}" name="room_price" type="text"
                                            class="form-control clearable" id="contact">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-3">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="deposit" value="{{ old('deposit') }}" type="text"
                                            class="form-control" id="inputDeposit">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="checkInTable" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Customer Name</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="countryTable" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Country Name</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="ProvinceTable" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Provinsi</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="cityTable" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Kota</th>
